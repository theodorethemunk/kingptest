        ...
        1292: (e, t, n) => {
            ...
            class CarouselHandlerBase extends i.default {
                ...
                applyOffsetSettings(e, t, n) {
                    ...
                    if (elementorFrontend.isEditMode() && "NestedCarousel" === this.constructor.name || !r || "none" === r) return;
                    this.getOffsetWidth();
                    switch (r) {
                        case "right":
            ...
            class NestedAccordion extends i.default {
                ...
                clickListener(e) {
                    ...
                    const t = e.currentTarget.parentElement,
                        ...
                        {
                            max_items_expended: i
                        } = this.getElementSettings(),
                        {
                            $accordionTitles: s,
                            $accordionItems: o
                        } = this.elements;
                    "one" === i && this.closeAllItems(o, s), t.open ? this.closeAccordionItem(t, e.currentTarget) : this.prepareOpenAnimation(t, e.currentTarget, r)
                }
                animateItem(e, t, n, r) {
                    e.style.overflow = "hidden";
                    let i = this.animations.get(e);
                    i && i.cancel(), i = e.animate({
                        height: [t, n]
                    }, {
                        duration: this.getAnimationDuration()
                    }), i.onfinish = () => this.onAnimationFinish(e, r), this.animations.set(e, i)
                }
        ...
        7323: (e, t, n) => {
            ...
            class NestedTabs extends i.default {
                ...
                bindEvents() {
                    ...
                    this.resizeListenerNestedTabs = s.setHorizontalScrollAlignment.bind(this, e), elementorFrontend.elements.$window.on("resize", this.resizeListenerNestedTabs), elementorFrontend.elements.$window.on("elementor/nested-tabs/activate", this.reInitSwipers)
                }
                unbindEvents() {
